...
<script>
    import customheader from "./parts/Header.vue";
    import customfooter from "./parts/footer.vue";
    export default {
        components:{
            customheader,
            customfooter
